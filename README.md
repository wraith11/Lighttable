...
| Map editor | Camera settings | Real-life setup |
|------------|-----------------|-----------------|
| ![Map editor](docs/images/MapEditor.png) | ![Camera settings](docs/images/CamSettings.png) | ![Real-life setup](docs/images/RealLife.jpg) |
